...
<H1>DESCRIPTION</H1>
<P>
**atdtool** is a command-line tools that contacts a After the Deadline language
...
<P>
The official server is free for personal use. For commercial needs, free server
software is provided. atdtool can be used with the default server or with a
custom one.
</P>
<H1>OPTIONS</H1>
<P>
